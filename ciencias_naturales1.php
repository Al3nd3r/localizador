...
<div class="row">
    	...
    	<div class="col-md-4">
    	<center><h1>Ciencias Naturales</h1></center>
    	<form method="POST" action="ciencias_naturales1.php">

	<center>
    	<div class ="form-group">
			<label for="nombr">Nombre</label>
			<input type="text" name="nombr" class="form-control" id="nombr">
		</div>
		<br>
        <div class ="form-group">
			<label for="apell">Apellido</label>
			<input type="text" name="apell" class="form-control" id="apell">
		</div>
		<br>
    <div class ="form-group">
			<label for="acti">Actividad</label>
			<input type="text" name="acti" class="form-control" id="acti">
		</div>
		<br>
		<div class ="form-group">
			<label for="notai">Nota</label>
			<input type="text" name="notai" class="form-control" id="notai">
		</div>
		<br>
    </center>
    <br>
   ...
   <?php
	...
	if (isset($_POST['btn2']))
	{
		...
		$resultados = mysqli_query($conexion,"SELECT * FROM $tabla_db3 WHERE nombr='$nombr'");
	...
	if (isset($_POST['btn4']))
	{
		...
		else
		{
			...
			{
		$_DELETE_SQL =  "DELETE FROM $tabla_db3 WHERE nombr = '$nombr'";
   ...
   <?php
	...
	if  (isset($_POST['btn1']))
	{
		...
		$notai  = $_POST['notai'];
 		...
 		$conexion->query ("INSERT INTO $tabla_db3 (nombr, apell, acti, notai) values ('$nombr', '$apell', '$acti', '$notai')");
