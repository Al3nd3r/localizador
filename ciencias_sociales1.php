...
<div class="row">
    	...
    	<div class="col-md-4">
    	<center><h1>Ciencias Sociales</h1></center>
    	<form method="POST" action="ciencias_sociales1.php">
	...
	<center>
        ...
        <div class ="form-group">
			...
			<input type="text" name="apellidoo" class="form-control" id="apellidoo">
		</div>
		<br>
    <div class ="form-group">
			<label for="actividadd">Actividad</label>
			<input type="text" name="actividadd" class="form-control" id="actividadd">
		</div>
		<br>
		<div class ="form-group">
			<label for="notaaa">Nota</label>
			<input type="text" name="notaaa" class="form-control" id="notaaa">
		</div>
		<br>
    </center>
    <br>
   ...
   <?php
	...
	if (isset($_POST['btn2']))
	{
		...
		$resultados = mysqli_query($conexion,"SELECT * FROM $tabla_db4 WHERE nombree='$nombree'");
		while($consulta = mysqli_fetch_array($resultados))
	{
		  echo $consulta['notaaa'];
	}
	}	
	...
	if (isset($_POST['btn4']))
	{
		...
		else
		{
			...
			{
		$_DELETE_SQL =  "DELETE FROM $tabla_db4 WHERE nombree = '$nombree'";
   ...
   <?php
	...
	if  (isset($_POST['btn1']))
	{
		...
		$notaaa  = $_POST['notaaa'];
 		...
 		$conexion->query ("INSERT INTO $tabla_db4 (nombree, apellidoo, actividadd, notaaa) values ('$nombree', '$apellidoo', '$actividadd', '$notaaa')");
