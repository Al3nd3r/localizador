...
<div class="row">
    	...
    	<div class="col-md-4">
    	<center><h1>Lengua</h1></center>
    	<form method="POST" action="lengua1.php">
   ...
   <?php
	...
	if (isset($_POST['btn4']))
	{
		...
		else
		{
			...
			{
		$_DELETE_SQL =  "DELETE FROM $tabla_db1 WHERE nombre = '$nombre'";
   ...
   <?php
	...
	if  (isset($_POST['btn1']))
	{
		...
		$nota  = $_POST['nota'];
 		...
 		$conexion->query ("INSERT INTO $tabla_db1 (nombre, apellido, actividad, nota) values ('$nombre', '$apellido', '$actividad', '$nota')");
